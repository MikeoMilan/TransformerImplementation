...
class Encoder(nn.Module):
    def __init__(self, 
                    n_src_vocab, d_word_vec,   # d_word_vec = d_model
                    n_layers, n_head, 
                    d_k, d_v, 
                    d_model, d_inner,          #d_model->the dim of output features   d_inner->the dim in positionwise                          
                    pad_idx, 
                    dropout=0.1, n_position=200, 
                    scale_emb=True):          # embedding scale: N(0,1/d_model)->N(0,1)
        ...
        self.layer_stack = nn.ModuleList([
            ...
            for _ in range(n_layers)])                          # stack layers up to the default value
